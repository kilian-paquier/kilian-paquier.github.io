...
$(document).ready(function () {
    ...
    function changeLanguage(newLanguage) {
        ...
        if ($(".stati18n-language-selector").attr("value") === "fr") {
            ...
            $(".stati18n.s18n-see-more").attr("onclick", "window.open('https://cvdesignr.com/p/5d9cd3013bcbb', '_blank')");
            ...
            $(".stati18n.s18n-see-more").attr("onclick", "window.open('https://cvdesignr.com/p/5ddff0dda9765', '_blank')");
            changeContactForm(userLanguage);
        }
        updateStatic();
    }
